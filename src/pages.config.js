...
export const PAGES = {
    ...
    "KickOffPublico": lazyPage(() => import('./pages/KickOffPublico')),
    "GerarKickOff": lazyPage(() => import('./pages/GerarKickOff')),
    ...
    "SubsellerDocUpload": lazyPage(() => import('./pages/SubsellerDocUpload')),
    "SubsellerInfoForm": lazyPage(() => import('./pages/SubsellerInfoForm')),
    "BankDataCollect": lazyPage(() => import('./pages/BankDataCollect')),
