...
export const DEFAULT_SEGMENT_RATES = [
  {
    ...
    mcc: "8299",
    riskLevel: "BAIXO",
    mdrAvista: 3.29, mdr2a6x: 3.69, mdr7a12x: 4.19, mdr13a21x: 4.69,
    percentualAntecipacao: 1.69,
    feeTransacao: 0.35, antifraude: 0.35, taxa3ds: 0.45,
    pixTaxaPercentual: 0.35, pixTaxaFixa: 0.30,
  },
  {
    segmentName: "Infoprodutos",
    mcc: "8299",
    riskLevel: "MÉDIO-ALTO",
    mdrAvista: 3.89, mdr2a6x: 4.39, mdr7a12x: 4.89, mdr13a21x: 5.39,
    percentualAntecipacao: 1.89,
    feeTransacao: 0.45, antifraude: 0.45, taxa3ds: 0.55,
    pixTaxaPercentual: 0.35, pixTaxaFixa: 0.30,
  },
  {
    ...
    mcc: "4816",
    riskLevel: "MÉDIO",
    mdrAvista: 3.49, mdr2a6x: 3.99, mdr7a12x: 4.49, mdr13a21x: 4.99,
    percentualAntecipacao: 1.69,
    feeTransacao: 0.39, antifraude: 0.39, taxa3ds: 0.49,
    pixTaxaPercentual: 0.35, pixTaxaFixa: 0.30,
  },
  {
    segmentName: "SaaS",
    ...
    mdrAvista: 3.49, mdr2a6x: 3.99, mdr7a12x: 4.49, mdr13a21x: 4.99,
    percentualAntecipacao: 1.69,
    feeTransacao: 0.35, antifraude: 0.29, taxa3ds: 0.45,
    pixTaxaPercentual: 0.35, pixTaxaFixa: 0.30,
  },
  {
    segmentName: "Marketplace",
    mcc: "5999/4816",
    riskLevel: "MÉDIO",
    mdrAvista: 3.49, mdr2a6x: 3.99, mdr7a12x: 4.49, mdr13a21x: 4.99,
    percentualAntecipacao: 1.69,
  ...
  },
  {
    ...
    mdrAvista: 3.99, mdr2a6x: 4.49, mdr7a12x: 4.99, mdr13a21x: 5.49,
    percentualAntecipacao: 1.99,
    feeTransacao: 0.55, antifraude: 0.59, taxa3ds: 0.65,
    pixTaxaPercentual: 0.35, pixTaxaFixa: 0.30,
  },
  {
    segmentName: "Dropshipping",
    mcc: "5999",
    riskLevel: "ALTO",
    mdrAvista: 4.19, mdr2a6x: 4.79, mdr7a12x: 5.39, mdr13a21x: 5.89,
    percentualAntecipacao: 2.29,
    feeTransacao: 0.49, antifraude: 0.49, taxa3ds: 0.55,
    pixTaxaPercentual: 0.35, pixTaxaFixa: 0.30,
  },
  {
    segmentName: "MPE",
    ...
    mdrAvista: 3.29, mdr2a6x: 3.69, mdr7a12x: 4.19, mdr13a21x: 4.69,
    percentualAntecipacao: 1.69,
    feeTransacao: 0.35, antifraude: 0.29, taxa3ds: 0.39,
    pixTaxaPercentual: 0.35, pixTaxaFixa: 0.30,
  },
  {
    segmentName: "Plataformas Verticais",
    mcc: "4816",
    riskLevel: "MÉDIO",
    mdrAvista: 3.49, mdr2a6x: 3.99, mdr7a12x: 4.49, mdr13a21x: 4.99,
    percentualAntecipacao: 1.69,
  ...
  {
    segmentName: "Link de Pagamento",
    mcc: "4816",
    riskLevel: "MÉDIO",
    mdrAvista: 3.49, mdr2a6x: 3.99, mdr7a12x: 4.49, mdr13a21x: 4.99,
    percentualAntecipacao: 1.69,
    feeTransacao: 0.39, antifraude: 0.35, taxa3ds: 0.45,
    pixTaxaPercentual: 0.35, pixTaxaFixa: 0.30,
  },
];