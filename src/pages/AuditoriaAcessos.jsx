      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-[#002443] flex items-center gap-2">
            <Shield className="w-6 h-6 text-[#2bc196]" /> Auditoria de Acessos
          </h1>
          <p className="text-sm text-[#002443]/60 mt-1">Log completo de ações e acessos na plataforma.</p>
        </div>
            ...
            {loading ? (
              ...
              <tr key={l.id} className="hover:bg-slate-50 text-sm">
                ...
                <td className="px-4 py-2.5">
                  <div className="text-[#002443]">{l.user_name || '—'}</div>
                ...
                <td className="px-4 py-2.5 text-xs text-slate-600">
                  ...
                  {l.target_action && <span className="text-[#2bc196] ml-1">[{l.target_action}]</span>}
