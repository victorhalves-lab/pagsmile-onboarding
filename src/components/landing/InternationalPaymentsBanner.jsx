...
export default function InternationalPaymentsBanner() {
  return (
    <motion.div
      ...
      className="relative overflow-hidden rounded-2xl border-2 border-[#0A0A0A]/10"
    >
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#0A0A0A] via-[#003366] to-[#004080]" />
      <div className="absolute top-0 right-0 w-80 h-80 bg-[#1356E2]/10 rounded-full blur-[100px]" />
      <div className="absolute bottom-0 left-0 w-60 h-60 bg-[#E84B1C]/8 rounded-full blur-[80px]" />

      <div className="relative z-10 p-6 md:p-8">
        {/* Header badge */}
        <div className="flex items-center gap-2 mb-4">
          <div className="flex items-center gap-2 bg-[#1356E2]/20 border border-[#1356E2]/30 rounded-full px-4 py-1.5">
            <Globe className="w-4 h-4 text-[#1356E2]" />
            <span className="text-xs font-bold text-[#1356E2] uppercase tracking-wider">Internacional</span>
          </div>
        ...
        <h3 className="text-xl md:text-2xl font-extrabold mb-2" style={{ color: '#ffffff' }}>
          ...
          <span style={{ color: '#1356E2' }}>Pin Bank</span>
        </h3>
        ...
        <div className="bg-white/[0.06] border border-white/[0.1] rounded-xl p-5 mb-6 flex flex-col md:flex-row items-center gap-4 md:gap-8">
          <div className="flex items-center gap-3">
            <div className="p-3 bg-[#1356E2]/15 rounded-xl">
              <CreditCard className="w-6 h-6 text-[#1356E2]" />
            </div>
            <div>
          ...
          <div className="flex items-baseline gap-1 md:ml-auto">
            <span className="text-3xl md:text-4xl font-extrabold" style={{ color: '#1356E2' }}>6,99</span>
            ...
            <span className="text-3xl md:text-4xl font-extrabold" style={{ color: '#1356E2' }}>0,50</span>
        ...
        <div className="bg-white/[0.06] border border-white/[0.1] rounded-xl p-4 mb-6 flex items-center gap-3">
          <div className="p-2.5 bg-[#1356E2]/15 rounded-xl">
          ...
          <div>
            ...
            <p className="text-xl font-extrabold" style={{ color: '#1356E2' }}>D + 7</p>
          </div>
        </div>

        {/* Regions */}
        <div className="flex items-center gap-2 mb-3">
          <MapPin className="w-4 h-4 text-[#1356E2]/60" />
        ...
        <div className="text-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-[#1356E2] hover:bg-[#1356E2]/90 text-white font-bold text-sm px-8 py-3 rounded-xl shadow-lg shadow-[#1356E2]/20 hover:scale-[1.02] transition-all"
          >
