...
export default function PagsmileHeader() {
  return (
    <div className="relative overflow-hidden rounded-3xl">
      <div className="bg-[#002443] py-14 md:py-20 px-8 md:px-16 relative">
        ...
        <div className="relative z-10">
          {/* Logo centralizado — SOMENTE Pagsmile */}
          <motion.div
          ...
          >
            <img src={PAGSMILE_LOGO} alt="Pagsmile" className="h-8 sm:h-10 md:h-12 w-auto object-contain" />
          </motion.div>
