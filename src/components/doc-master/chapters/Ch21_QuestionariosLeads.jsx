        ...
        <section>
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-xl bg-[#002443]/5 flex items-center justify-center">
              <CreditCard className="w-5 h-5 text-[#002443]" />
            </div>
            <div>
              <h2 className="text-xl font-bold text-[#002443]">Questionário de Leads V5 — Cartão</h2>
              <p className="text-xs text-[#002443]/60">Captação de leads de processamento de cartão (Visa/Master/Elo/Amex)</p>
            </div>
          </div>
      ...
      {tab === 'pix' && (
        <section>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h2 className="text-xl font-bold text-[#002443]">Questionário de Leads Pix V4</h2>
              <p className="text-xs text-[#002443]/60">Captação de leads de processamento PIX (merchant direto + intermediário)</p>
            </div>
          </div>
