...
export default function AssinaturaForm({ contract, onChange }) {
  ...
  return (
    <div className="space-y-6">
      {/* Data e Vigência */}
      <div>
        <h3 className="text-sm font-bold text-[#0A0A0A] border-b border-[#0A0A0A]/10 pb-2 mb-3">Data e Vigência</h3>
      ...
      <div>
        <h3 className="text-sm font-bold text-[#0A0A0A] border-b border-[#0A0A0A]/10 pb-2 mb-3">Multa Rescisória - Contratante</h3>
        <div className="grid grid-cols-2 gap-3">
      ...
      {/* Multa Rescisória - Pin Bank */}
      <div>
        <h3 className="text-sm font-bold text-[#0A0A0A] border-b border-[#0A0A0A]/10 pb-2 mb-3">Multa Rescisória - Pin Bank</h3>
        <div className="grid grid-cols-2 gap-3">
      ...
      {/* Representante Pin Bank */}
      <div>
        <h3 className="text-sm font-bold text-[#0A0A0A] border-b border-[#0A0A0A]/10 pb-2 mb-3">Representante Pin Bank</h3>
      ...
      {/* Testemunhas */}
      <div>
        <h3 className="text-sm font-bold text-[#0A0A0A] border-b border-[#0A0A0A]/10 pb-2 mb-3">Testemunhas</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-3 p-3 rounded-xl bg-[#0A0A0A]/[0.02] border border-[#0A0A0A]/5">
            <p className="text-xs font-semibold text-[#0A0A0A]/70">Testemunha 1</p>
          ...
          <div className="space-y-3 p-3 rounded-xl bg-[#0A0A0A]/[0.02] border border-[#0A0A0A]/5">
            <p className="text-xs font-semibold text-[#0A0A0A]/70">Testemunha 2</p>
      ...
      <div>
        <h3 className="text-sm font-bold text-[#0A0A0A] border-b border-[#0A0A0A]/10 pb-2 mb-3">Cláusulas Customizadas</h3>
        <textarea
          ...
          className="w-full h-32 border rounded-xl p-3 text-sm resize-none focus:outline-none focus:ring-2 focus:ring-[#1356E2]"
        />
      </div>

      {/* Notas internas */}
      <div>
        <h3 className="text-sm font-bold text-[#0A0A0A] border-b border-[#0A0A0A]/10 pb-2 mb-3">Notas Internas</h3>
        <textarea
          ...
          className="w-full h-20 border rounded-xl p-3 text-sm resize-none focus:outline-none focus:ring-2 focus:ring-[#1356E2]"
        />
      </div>
    </div>
  );
