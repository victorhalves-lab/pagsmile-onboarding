...
import { Copy, Check, ExternalLink, ShoppingCart, GraduationCap, Lightbulb, Monitor, Globe, Store } from 'lucide-react';
...
const ALL_SEGMENTS = ['E-commerce', 'Educação', 'Infoprodutos', 'SaaS', 'Gateway', 'Marketplace'];
