      ...
      <div className="bg-amber-50 border border-amber-200 rounded-2xl p-6">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-sm text-[#002443]/60">Esta proposta ainda é um rascunho. Gere a proposta para obter o link de envio ao cliente.</p>
          </div>
        </div>
      </div>
    );
    ...
    <div className="bg-white rounded-2xl border border-[#2bc196]/30 shadow-sm p-6">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p className="text-sm text-[#002443]/60">Copie e envie este link para o cliente visualizar e responder a proposta.</p>
        </div>
      </div>

      {/* Link display */}
      <div className="flex items-center gap-2 bg-[#f4f4f4] rounded-xl p-3 mb-4">
        <code className="flex-1 text-sm text-[#002443]/70 truncate select-all font-mono">
          {publicLink}
        </code>
        <Button
          onClick={handleCopy}
      ...
      <div className="flex items-center gap-3">
        ...
        <a href={publicLink} target="_blank" rel="noopener noreferrer">
          <Button variant="ghost" size="sm" className="gap-2 text-[#002443]/60">
