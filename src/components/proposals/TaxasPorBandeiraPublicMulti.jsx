...
export default function TaxasPorBandeiraPublicMulti({
  ...
  return (
    <div className="space-y-3">
      {/* Banner informativo */}
      <div className="rounded-xl border border-[#2bc196]/30 bg-[#2bc196]/5 px-4 py-3 flex items-start gap-3">
        <Layers className="w-4 h-4 text-[#36706c] mt-0.5 flex-shrink-0" />
        <div className="text-xs text-[#002443]/80 leading-relaxed">
          ...
          <button
            ...
            className={`flex items-center gap-2 px-3 py-2 rounded-xl text-xs font-bold transition-all ${
              activeIdx === idx
                ...
                : 'bg-slate-100 text-[#002443]/60 hover:bg-slate-200'
            }`}
          >
      ...
      <div className="pt-4 border-t border-slate-100">
        <p className="text-xs font-semibold text-[#002443]/60 uppercase tracking-wide mb-2 flex items-center gap-1.5">
