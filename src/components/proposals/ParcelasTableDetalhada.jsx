              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b-2 border-[#1356E2]/20">
                    ...
                    <th className="text-right py-2 px-3 font-semibold text-[#E84B1C]">Taxa</th>
                  </tr>
                </thead>
                <tbody>
                  {rows.map(r => (
                    <tr key={r.parcela} className="border-b border-[#0A0A0A]/5 hover:bg-[#1356E2]/5">
                      ...
                      {(() => {
                        ...
                        return (
                          <td className={`py-2 px-3 text-right font-bold ${applyOverride ? 'text-amber-500' : 'text-[#E84B1C]'}`}>
                            {val.toFixed(2)}%
                          </td>
                        );
                      })()}
