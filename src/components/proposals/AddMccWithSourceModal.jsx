    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" onClick={onClose}>
      ...
      >
        ...
        <div className="flex items-start justify-between p-5 border-b border-slate-200">
          <div>
            <h2 className="text-lg font-bold text-[#002443]">Taxas iniciais do novo MCC</h2>
        ...
        <div className="p-5 space-y-2">
          <p className="text-[11px] uppercase tracking-wider font-bold text-[#002443]/40 mb-3">
            Como preencher as taxas deste MCC?
          </p>

          {/* Opção 1 — copiar do MCC ativo */}
          <label className={`flex items-start gap-3 p-4 rounded-xl border-2 cursor-pointer transition-all ${
            source === 'active' ? 'border-[#2bc196] bg-[#2bc196]/5' : 'border-slate-200 hover:border-slate-300'
          }`}>
            <input
              type="radio"
              name="source"
              ...
              className="mt-1 accent-[#2bc196]"
            />
            <div className="flex-1">
              <div className="flex items-center gap-2">
                <Copy className="w-4 h-4 text-[#002443]/70" />
                <span className="text-sm font-bold text-[#002443]">Copiar do MCC ativo</span>
              </div>
              <p className="text-xs text-[#002443]/60 mt-1">
          ...
          <label className={`flex items-start gap-3 p-4 rounded-xl border-2 cursor-pointer transition-all ${
            source === 'segment' ? 'border-[#2bc196] bg-[#2bc196]/5' : 'border-slate-200 hover:border-slate-300'
          }`}>
            <input
              type="radio"
              name="source"
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-bold text-[#002443]">Usar taxas padrão de um segmento</span>
              </div>
              <p className="text-xs text-[#002443]/60 mt-1">
              ...
              {source === 'segment' && (
                <div className="mt-3">
                  <select
                    ...
                    className="w-full h-10 px-3 rounded-lg border border-slate-300 bg-white text-sm text-[#002443] focus:outline-none focus:ring-2 focus:ring-[#2bc196]"
                  >
                    <option value="">
          ...
          {/* Opção 3 — branco */}
          <label className={`flex items-start gap-3 p-4 rounded-xl border-2 cursor-pointer transition-all ${
            source === 'blank' ? 'border-[#2bc196] bg-[#2bc196]/5' : 'border-slate-200 hover:border-slate-300'
          }`}>
            <input
              type="radio"
              name="source"
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-bold text-[#002443]">Começar em branco</span>
              </div>
              <p className="text-xs text-[#002443]/60 mt-1">
