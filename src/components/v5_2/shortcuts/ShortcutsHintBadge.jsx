      ...
      <Tooltip delayDuration={300}>
        <TooltipTrigger asChild>
          <button
            ...
            className="fixed bottom-4 right-4 z-30 inline-flex items-center gap-2 px-3 py-2 rounded-full bg-[#0A0A0A] text-white shadow-lg hover:bg-[#0A0A0A]/90 hover:shadow-xl transition-all border border-[#1356E2]/30"
          >
            <Keyboard className="w-3.5 h-3.5 text-[#1356E2]" />
        ...
        <TooltipContent side="left" className="bg-[#0A0A0A] text-white border-white/10 text-xs">
