  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 p-5">
      <div className="flex items-center gap-2 mb-4">
        <Shield className="w-4 h-4 text-[#1356E2]/70" />
        <h3 className="font-bold text-[#1356E2]">{t('chart.risk_distribution')}</h3>
      </div>
        ...
        {categories.map((cat, index) => {
          ...
          return (
            <div key={index} className={`rounded-lg p-3 ${cat.bgColor} text-center`}>
              ...
              <p className="text-xs text-[#0A0A0A]/60 font-semibold mb-1">{cat.label}</p>
