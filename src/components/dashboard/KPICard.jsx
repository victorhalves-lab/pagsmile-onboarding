    ...
    <div className={`bg-white rounded-xl border border-slate-200 p-4 ${className}`}>
      <div className="flex items-start justify-between">
        <div className="flex-1">
          ...
          <p className={`font-bold text-slate-800 ${size === 'large' ? 'text-3xl' : 'text-2xl'}`}>
            {value}
          </p>
          {subtitle && (
    ...
    <div className="bg-white rounded-xl border border-slate-200 p-4">
      ...
      <div className="flex items-center justify-center gap-3 mb-3">
        <div className="text-center">
          ...
          <p className="text-xl font-bold text-slate-400">{beforeValue}</p>
        </div>
        <ArrowRight className="w-4 h-4 text-slate-300" />
        <div className="text-center">
          <p className="text-xs text-slate-400">{afterLabel}</p>
      ...
      {improvementLabel && (
        <p className="text-xs text-slate-500 text-center mt-2">{improvementLabel}</p>
      )}
