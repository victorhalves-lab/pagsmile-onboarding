...
export default function StepVolumePix({ form, updateField, errors }) {
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-lg font-bold text-[#002443]">Volume PIX</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        ...
        <div>
          ...
          <p className="text-[10px] text-[#002443]/40 mt-0.5">TPV ÷ Ticket Médio</p>
        </div>
      </div>
      ...
      <div>
        ...
        <p className="text-[10px] text-[#002443]/40 mt-1">PIX funciona 24/7. O horário define padrão de normalidade para monitoramento.</p>
      </div>
    </div>
  );
}