...
const EXPLANATIONS = {
  ...
  // ═══ ESG — NEW ═══
  'Lista Suja MTE — Trabalho Escravo': 'A Lista Suja do Ministério do Trabalho e Emprego registra empregadores que foram autuados pela prática de trabalho em condições análogas à escravidão. A presença nesta lista é BLOQUEIO AUTOMÁTICO IMEDIATO sem exceção. A legislação brasileira proíbe qualquer relação comercial com empresas na Lista Suja. A Pin Bank pode ser responsabilizada como cúmplice se processar pagamentos para essas empresas.',
