...
const DATASET_LABELS = {
  ...
  'registration_data': { label: 'Dados de Registro', category: 'cadastral' },
  'addresses': { label: 'Endereços', category: 'cadastral' },
  ...
  // Digital
  'online_presence': { label: 'Presença Digital', category: 'digital' },
