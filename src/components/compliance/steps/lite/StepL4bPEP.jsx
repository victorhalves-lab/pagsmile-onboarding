      ...
      <div className="grid gap-5">
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-4">
            ...
            >
              <p className={`font-semibold ${formData.socioPEP === true ? 'text-amber-600' : 'text-[var(--pagsmile-blue)]'}`}>Sim</p>
            </button>
            <button
              type="button"
            ...
            >
              <p className={`font-semibold ${formData.socioPEP === false ? 'text-[var(--pagsmile-green)]' : 'text-[var(--pagsmile-blue)]'}`}>Não</p>
            </button>
          </div>
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-4">
            ...
            >
              <p className={`font-semibold ${formData.socioSancionado === true ? 'text-red-600' : 'text-[var(--pagsmile-blue)]'}`}>Sim</p>
            </button>
            <button
              type="button"
            ...
            >
              <p className={`font-semibold ${formData.socioSancionado === false ? 'text-[var(--pagsmile-green)]' : 'text-[var(--pagsmile-blue)]'}`}>Não</p>
            </button>
          </div>
        </div>
