    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-5">
        <div className="space-y-2">
          <Label className="text-[var(--pagsmile-blue)] font-semibold">Tipo de Empresa</Label>
          <Select
        ...
        <div className="p-5 bg-slate-50 rounded-xl border border-slate-200 space-y-4">
          ...
          <div className="space-y-2">
            <Label className="text-[var(--pagsmile-blue)] font-semibold text-sm">Nome Completo</Label>
            <Input
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-2">
              <Label className="text-[var(--pagsmile-blue)] font-semibold text-sm">CPF</Label>
              <Input
            ...
            <div className="space-y-2">
              <Label className="text-[var(--pagsmile-blue)] font-semibold text-sm">E-mail</Label>
              <Input
                type="email"
