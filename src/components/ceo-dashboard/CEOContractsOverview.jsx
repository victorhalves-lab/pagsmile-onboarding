...
const STATUS_CONFIG = {
  ...
  sent: { label: 'Enviado', color: 'bg-[#E84B1C]/10 text-[#E84B1C]' },
  signed: { label: 'Assinado', color: 'bg-[#1356E2]/10 text-[#1356E2]' },
    ...
    <div className="bg-white rounded-2xl border border-[#0A0A0A]/5 p-5">
      <div className="flex items-center gap-2 mb-4">
        <div className="w-8 h-8 rounded-xl bg-[#0A0A0A]/5 flex items-center justify-center">
          <PenTool className="w-4 h-4 text-[#0A0A0A]" />
        </div>
        <div>
          <h3 className="text-sm font-bold text-[#0A0A0A]">Contratos</h3>
          <p className="text-[10px] text-[#0A0A0A]/40">{total} total</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-5 gap-2 mb-4">
        <div className="text-center p-2.5 rounded-xl bg-slate-50">
          ...
          <p className="text-[9px] text-[#0A0A0A]/40 font-bold">Pré-gerado</p>
        </div>
        <div className="text-center p-2.5 rounded-xl bg-blue-50">
          <p className="text-lg font-extrabold text-blue-500">{underReview}</p>
          <p className="text-[9px] text-[#0A0A0A]/40 font-bold">Em Revisão</p>
        </div>
        <div className="text-center p-2.5 rounded-xl bg-yellow-50">
          <p className="text-lg font-extrabold text-yellow-600">{ready}</p>
          <p className="text-[9px] text-[#0A0A0A]/40 font-bold">Prontos</p>
        </div>
        <div className="text-center p-2.5 rounded-xl bg-[#E84B1C]/5">
          <p className="text-lg font-extrabold text-[#E84B1C]">{sent}</p>
          <p className="text-[9px] text-[#0A0A0A]/40 font-bold">Enviados</p>
        </div>
        <div className="text-center p-2.5 rounded-xl bg-[#1356E2]/5">
          <p className="text-lg font-extrabold text-[#1356E2]">{signed}</p>
          <p className="text-[9px] text-[#0A0A0A]/40 font-bold">Assinados</p>
        </div>
      </div>
          ...
          return (
            <div key={status} className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <div className="w-24 h-1.5 bg-[#0A0A0A]/5 rounded-full overflow-hidden">
                  <div className="h-full bg-[#1356E2] rounded-full" style={{ width: `${pct}%` }} />
                </div>
                <span className="text-xs font-bold text-[#0A0A0A]/50 w-8 text-right">{count}</span>
              </div>
            </div>
          );
        })}
