      ...
      <CardContent className="space-y-5">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <Label className="text-xs text-[#0A0A0A]/60">1x (%)</Label>
            ...
            <div>
              <Label className="text-xs text-[#0A0A0A]/60">2-6x (%)</Label>
            ...
            <div>
              <Label className="text-xs text-[#0A0A0A]/60">7-12x (%)</Label>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <Label className="text-xs text-[#0A0A0A]/60">Tipo de Antecipação</Label>
            ...
            <div>
              <Label className="text-xs text-[#0A0A0A]/60">Taxa de Antecipação (%)</Label>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <Label className="text-xs text-[#0A0A0A]/60">Provedor de Antifraude</Label>
            ...
            <div>
              <Label className="text-xs text-[#0A0A0A]/60">Custo do Antifraude (R$)</Label>
