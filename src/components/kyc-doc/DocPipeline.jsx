  ...
  return (
    <S>
      ...
      <Table headers={['Step', 'Nome da Função', 'Duração Típica', 'O que faz — descrição completa', 'Não-bloqueante?']} rows={[
        ...
        ['2.7', 'cafVerifaiDocs', '1–5 seg/doc', 'Para cada documento que foi enviado e ainda está com status "Pendente", a IA VerifAI da CAF analisa: autenticidade, legibilidade, conformidade com o tipo esperado, e sinais de adulteração digital. O resultado atualiza o status do documento para "Validado" ou "Rejeitado".', '✅ Sim'],
