  ...
  return (
    <S>
      ...
      <Table headers={['Serviço', 'Síncrono/Assíncrono', 'O que verifica em detalhe', 'Red Flag gerado se falhar']} rows={[
        ...
        ['privateFaceset', 'Assíncrono', 'Verifica se o MESMO rosto já foi cadastrado no sistema da Pin Bank com um CPF diferente. Detecta reuso de identidade — uma pessoa usando múltiplos CPFs para abrir contas.', 'FACE_REUSE_DIFFERENT_CPF → red flag grave, indica fraude de identidade.'],
