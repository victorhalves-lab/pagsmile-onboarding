  ...
  return (
    <div className="bg-white">
      ...
      <div className="no-print sticky top-[68px] z-[5] bg-white border-b border-[#e8e8e8] flex items-center justify-between max-w-[1100px] mx-auto px-6 py-3">
        <div>
          <p className="text-[10px] font-bold tracking-[0.2em] uppercase text-[#1356E2]">Documento Técnico — Auditoria</p>
          <p className="text-sm font-bold text-[#0A0A0A]">{title}</p>
        </div>
        <Button onClick={handlePrint} className="bg-[#1356E2] hover:bg-[#1356E2]/90 text-white">
      ...
      <div id={id} className="risk-doc max-w-[900px] mx-auto px-8 py-6">
        ...
        <section className="risk-cover">
          <p className="risk-cover-eyebrow">PIN BANK • COMPLIANCE V4 • DOCUMENTO TÉCNICO PARA AUDITORIA</p>
          <h1>{title}</h1>
          <h2>{subtitle}</h2>
        ...
        <div className="risk-footer">
          <p>Pin Bank — {title} — V{version} — {new Date().toLocaleDateString('pt-BR')}</p>
...
function PrintStyles({ scopeId }) {
  return (
    <style>{`
      ...
      #${scopeId} h1, #${scopeId} h2, #${scopeId} h3, #${scopeId} h4 { color: #0A0A0A; }
      #${scopeId} .risk-cover { border-bottom: 2px solid #1356E2; padding: 36px 0 30px; margin-bottom: 28px; }
      #${scopeId} .risk-cover-eyebrow { font-size: 10px; letter-spacing: 0.2em; color: #1356E2; font-weight: 800; margin-bottom: 14px; }
      #${scopeId} .risk-cover h1 { font-size: 32px; font-weight: 900; line-height: 1.1; margin-bottom: 6px; color: #0A0A0A; }
      ...
      #${scopeId} .risk-cover-meta div { display: flex; flex-direction: column; padding: 6px 10px; background: #f9fafb; border-left: 3px solid #1356E2; }
      ...
      #${scopeId} .risk-cover-meta .val { font-size: 11.5px; color: #0A0A0A; font-weight: 600; line-height: 1.3; }
      #${scopeId} .risk-toc { background: #f9fafb; padding: 20px 26px; border-radius: 6px; margin-bottom: 28px; page-break-after: always; }
      #${scopeId} .risk-toc h3 { font-size: 16px; margin-bottom: 12px; color: #0A0A0A; }
      ...
      #${scopeId} .risk-section h1 { font-size: 19px; font-weight: 900; padding-bottom: 6px; border-bottom: 2px solid #1356E2; margin: 18px 0 14px; color: #0A0A0A; }
      #${scopeId} .risk-section h2 { font-size: 13.5px; font-weight: 800; margin: 16px 0 6px; color: #0A0A0A; }
      #${scopeId} .risk-section h3 { font-size: 12px; font-weight: 700; margin: 10px 0 4px; color: #1356E2; }
      #${scopeId} .risk-section p { font-size: 12px; line-height: 1.55; color: #1a1a1a; margin-bottom: 8px; }
      #${scopeId} .risk-section strong { color: #0A0A0A; font-weight: 700; }
      #${scopeId} .risk-section em { color: #1a1a1a; font-style: italic; }
      #${scopeId} .risk-section code { background: #f0f4f8; color: #0A0A0A; font-size: 10.5px; padding: 1px 4px; border-radius: 2px; font-family: ui-monospace, monospace; }
      ...
      #${scopeId} .risk-table thead th { background: #0A0A0A; color: white; padding: 6px 8px; text-align: left; font-weight: 700; font-size: 10px; }
      ...
      #${scopeId} .risk-formula { background: #0A0A0A; color: #E84B1C; padding: 10px 14px; font-family: ui-monospace, monospace; font-size: 11px; line-height: 1.55; border-radius: 4px; overflow-x: auto; white-space: pre; margin: 8px 0 14px; }
      ...
      #${scopeId} .risk-callout { background: #ecfdf5; border-left: 3px solid #1356E2; padding: 8px 12px; font-size: 11px; color: #1a1a1a; margin: 10px 0; }
      #${scopeId} .risk-dl dt { font-weight: 700; color: #0A0A0A; margin-top: 6px; font-size: 11.5px; }
