 ...
 * "página em construção" mantendo o design system Pagsmile.
 */
export default function StubSection({ title, subtitle, phase = 2, icon: Icon = Construction }) {
  return (
    <div className="bg-white rounded-2xl border border-[#002443]/5 shadow-sm p-10">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          {subtitle && <p className="text-[#002443]/60 text-sm">{subtitle}</p>}
          <div className="mt-6 p-4 rounded-xl bg-[#f4f4f4] border border-[#002443]/5 text-sm text-[#002443]/70">
