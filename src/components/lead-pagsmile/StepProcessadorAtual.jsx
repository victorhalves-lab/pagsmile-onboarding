...
export default function StepProcessadorAtual({ form, updateField, errors = {} }) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-lg font-bold text-[#002443]">Processador & Dores do Mercado</h2>
      </div>
      ...
      {jaProcessa && (
        <>
          ...
          {insatisfeito && (
            <div className="space-y-2">
              <label className="text-sm font-semibold text-[#002443]">Principal dor com seu processador atual</label>
              <ButtonSelector
      ...
      <div className="space-y-3 pt-2 border-t border-[#002443]/10" data-field="doresMercado">
        <div>
        ...
        <div className="space-y-1">
          <label className="text-xs font-medium text-[#002443]/60">Outras dores (opcional)</label>
          <input
            type="text"
            ...
            className="w-full h-10 rounded-xl border border-[#002443]/10 px-4 text-sm bg-white"
          />
        </div>
