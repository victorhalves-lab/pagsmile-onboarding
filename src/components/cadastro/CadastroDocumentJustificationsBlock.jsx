          ...
          return (
            <div key={d.id} className="p-3 bg-amber-50 rounded-lg">
              <div className="flex items-start justify-between gap-2 mb-1.5">
                <p className="text-sm font-semibold text-[var(--pinbank-blue)]">{d.documentName || 'Documento'}</p>
              ...
              {d.notAvailableReason && (
                <div className="mb-2">
                  <p className="text-[10px] text-[var(--pinbank-blue)]/50">Justificativa do cliente:</p>
                  <p className="text-xs text-[var(--pinbank-blue)]/80 whitespace-pre-wrap">{d.notAvailableReason}</p>
                </div>
              )}
