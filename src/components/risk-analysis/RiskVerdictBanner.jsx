...
const BLOCK_EXPLANATIONS = {
  ...
  'B07': { title: 'Adverse Media Grave', explanation: 'Foram encontradas notícias na mídia com sentimento MUITO NEGATIVO associadas a temas como fraude, lavagem de dinheiro ou corrupção. Isso representa risco reputacional e regulatório extremo para a Pagsmile.', action: 'Recusa automática por risco reputacional.' },
