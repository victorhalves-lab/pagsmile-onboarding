    ...
    <div className="space-y-5">
      <div className="bg-gradient-to-r from-[#002443] to-[#003366] rounded-2xl p-5 text-white">
        <h3 className="text-lg font-bold mb-2 flex items-center gap-2">
          <Handshake className="w-5 h-5 text-[#5cf7cf]" /> Dois Módulos Distintos
        </h3>
      ...
      <div>
        <h4 className="font-bold text-[#002443] text-sm mb-3 flex items-center gap-2">
          <Building2 className="w-4 h-4 text-[#2bc196]" /> Módulo 1 — Parceiros Externos de Compliance
        </h4>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <Card className="border-slate-200">
            <CardHeader className="pb-2"><CardTitle className="text-sm">Entidades</CardTitle></CardHeader>
            <CardContent className="pt-2 space-y-1.5 text-xs text-[#002443]/75">
          ...
          <Card className="border-slate-200 md:col-span-2">
            ...
            <CardContent className="pt-2 grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-1 text-xs text-[#002443]/75">
      ...
      <div>
        <h4 className="font-bold text-[#002443] text-sm mb-3 flex items-center gap-2">
          <FileSpreadsheet className="w-4 h-4 text-[#2bc196]" /> Módulo 2 — Doc Compliance Parceiros + Coleta Bancária + Pré-KYC
        </h4>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <Card className="border-emerald-200">
            ...
            <CardContent className="pt-2 space-y-1 text-xs text-[#002443]/75">
          ...
          <Card className="border-purple-200">
            <CardHeader className="bg-purple-50/60 pb-2"><CardTitle className="text-sm">3. Export "Pré KYC Pagsmile"</CardTitle></CardHeader>
            <CardContent className="pt-2 space-y-1 text-xs text-[#002443]/75">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
        ...
        <p className="text-xs text-blue-800 leading-relaxed">
          <strong>Módulo 1</strong> é colaboração externa: parceiro recomenda decisão. <strong>Módulo 2</strong> é extração interna: equipe Pagsmile pega dados estruturados e envia aos bancos BaaS para abrir conta operacional. O Módulo 2 não persiste nada além dos <code>BankDataCollection</code> criados — o XLSX é base64 encoded e baixado localmente.
        </p>
      </div>
    </div>
  );
