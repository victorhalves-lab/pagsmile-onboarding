    ...
    <div className="bg-white rounded-xl border border-slate-200 p-5">
      ...
      {!hasData ? (
        <div className="flex flex-col items-center justify-center h-[240px] text-center px-4">
          <TrendingUp className="w-10 h-10 text-[#002443]/10 mb-3" />
          <p className="text-sm text-[#002443]/40 font-medium">Sem dados de rentabilidade calculados</p>
          <p className="text-xs text-[#002443]/30 mt-1">Os dados aparecem quando propostas aceitas possuem TPV e taxas definidas</p>
        </div>
      ) : (
