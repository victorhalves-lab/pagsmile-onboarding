  ...
  try {
    ...
    const html = buildEmail({
      ...
      body: [
        ...
        `<strong>O que acontece agora?</strong><br>Nossa equipe já está analisando suas informações. Em breve, um consultor entrará em contato para discutir a melhor solução para o seu negócio.`,
