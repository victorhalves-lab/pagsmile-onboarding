 ...
 * Trigger: OnboardingCase [update] quando isSubsellerCase=true e status muda para Aprovado/Recusado
 */
  ...
  try {
    ...
    const html = buildEmail({
      ...
      body: isApproved ? [
        ...
        `Para orientações sobre como regularizar a situação, entre em contato pelos canais oficiais da Pagsmile.`,
      ],
