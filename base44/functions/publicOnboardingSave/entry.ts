...
// PUBLIC endpoint. Strip auth headers and use createClientFromRequest so that
// asServiceRole works without triggering users/me validation. See
// publicOnboardingBootstrap for the full rationale.
