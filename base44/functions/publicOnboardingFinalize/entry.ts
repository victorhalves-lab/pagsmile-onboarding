...
// for the full rationale: createClientFromRequest with an expired token triggers
// a background users/me validation that throws "Authentication required to view users".
